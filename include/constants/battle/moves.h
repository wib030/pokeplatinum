...
#define MOVE_STATUS_TYPE_IMMUNE_HEAL_ABILITY       (1 << 22)
#define MOVE_STATUS_TYPE_IMMUNE_RAISE_STAT_ABILITY (1 << 23)
#define MOVE_STATUS_TYPE_IMMUNE_TYPE_BOOST_ABILITY (1 << 24)
#define MOVE_STATUS_TYPE_WEAKNESS_ABILITY          (1 << 25)
#define MOVE_STATUS_TYPE_RESIST_ABILITY            (1 << 26)
#define MOVE_STATUS_TYPE_IGNORE_IMMUNITY           (1 << 27)
#define MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ABILITY   (1 << 28)
#define MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ITEM      (1 << 29)
#define MOVE_STATUS_POWDER_IMMUNITY      		   (1 << 30)
...
#define MOVE_STATUS_IMMUNE              (MOVE_STATUS_DID_NOT_AFFECT | MOVE_STATUS_LEVITATED | MOVE_STATUS_MAGNET_RISE \
                                        | MOVE_STATUS_TYPE_IMMUNE_HEAL_ABILITY | MOVE_STATUS_TYPE_IMMUNE_RAISE_STAT_ABILITY \
                                        | MOVE_STATUS_TYPE_IMMUNE_TYPE_BOOST_ABILITY | MOVE_STATUS_POWDER_IMMUNITY)
#define MOVE_STATUS_GENERAL_MISS        (MOVE_STATUS_MISSED | MOVE_STATUS_SEMI_INVULNERABLE)
#define MOVE_STATUS_BASIC_EFFECTIVENESS (MOVE_STATUS_SUPER_EFFECTIVE | MOVE_STATUS_NOT_VERY_EFFECTIVE | MOVE_STATUS_TYPE_WEAKNESS_ABILITY \
                                        | MOVE_STATUS_TYPE_RESIST_ABILITY | MOVE_STATUS_TYPE_IGNORE_IMMUNITY | MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ABILITY \
                                        | MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ITEM)
