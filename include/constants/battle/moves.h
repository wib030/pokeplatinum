...
#define MOVE_EFFECT_HEAL_INVERSION          (1 << 19)
// unused flag: 1 << 20
...
#define MOVE_EFFECT_PREVENT_HEALING         (MOVE_EFFECT_HEAL_BLOCK | MOVE_EFFECT_HEAL_INVERSION)
...
#define MOVE_EFFECT_BATON_PASSED    (MOVE_EFFECT_LEECH_SEED_RECIPIENT | MOVE_EFFECT_LEECH_SEED | MOVE_EFFECT_LOCK_ON | MOVE_EFFECT_PERISH_SONG | MOVE_EFFECT_INGRAIN \
                                    ...
                                    | MOVE_EFFECT_ABILITY_SUPPRESSED | MOVE_EFFECT_EMBARGO | MOVE_EFFECT_HEAL_BLOCK | MOVE_EFFECT_MAGNET_RISE | MOVE_EFFECT_HEAL_INVERSION)

#define MOVE_EFFECT_BATON_PASS_GOOD (MOVE_EFFECT_INGRAIN | MOVE_EFFECT_AQUA_RING | MOVE_EFFECT_MAGNET_RISE)
...
#define MOVE_STATUS_ABSORBED      (MOVE_STATUS_LEVITATED | MOVE_STATUS_MAGNET_RISE | MOVE_STATUS_TYPE_IMMUNE_HEAL_ABILITY \
                                    | MOVE_STATUS_TYPE_IMMUNE_RAISE_STAT_ABILITY | MOVE_STATUS_TYPE_IMMUNE_TYPE_BOOST_ABILITY \
                                    | MOVE_STATUS_POWDER_IMMUNITY)
...
//#define MOVE_STATUS_DID_NOT_HIT (MOVE_STATUS_DID_NOT_HIT_1 | MOVE_STATUS_DID_NOT_HIT_2)
...
#define MOVE_STATUS_IGNORE_IMMUNITY     (MOVE_STATUS_TYPE_IGNORE_IMMUNITY | MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ABILITY | MOVE_STATUS_TYPE_IGNORE_IMMUNITY_ITEM)
#define MOVE_STATUS_RESISTED            (MOVE_STATUS_NOT_VERY_EFFECTIVE | MOVE_STATUS_TYPE_RESIST_ABILITY)
#define MOVE_STATUS_WEAK                (MOVE_STATUS_SUPER_EFFECTIVE | MOVE_STATUS_TYPE_WEAKNESS_ABILITY)
#define MOVE_STATUS_IMMUNE_ABILITY      (MOVE_STATUS_LEVITATED | MOVE_STATUS_TYPE_IMMUNE_HEAL_ABILITY | MOVE_STATUS_TYPE_IMMUNE_RAISE_STAT_ABILITY \
                                        | MOVE_STATUS_TYPE_IMMUNE_TYPE_BOOST_ABILITY | MOVE_STATUS_WONDER_GUARD)
