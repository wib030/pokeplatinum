...
#define MOVE_STATUS_ABILITY_TYPE_IMMUNE_HEAL       (1 << 22)
#define MOVE_STATUS_ABILITY_TYPE_IMMUNE_RAISE_STAT (1 << 23)
#define MOVE_STATUS_ABILITY_TYPE_IMMUNE_TYPE_BOOST (1 << 24)
#define MOVE_STATUS_ABILITY_TYPE_WEAKNESS          (1 << 25)
...
#define MOVE_STATUS_IMMUNE              (MOVE_STATUS_DID_NOT_AFFECT | MOVE_STATUS_LEVITATED | MOVE_STATUS_MAGNET_RISE \
                                        | MOVE_STATUS_ABILITY_TYPE_IMMUNE_HEAL | MOVE_STATUS_ABILITY_TYPE_IMMUNE_RAISE_STAT \
                                        | MOVE_STATUS_ABILITY_TYPE_IMMUNE_TYPE_BOOST)
#define MOVE_STATUS_GENERAL_MISS        (MOVE_STATUS_MISSED | MOVE_STATUS_SEMI_INVULNERABLE)
#define MOVE_STATUS_BASIC_EFFECTIVENESS (MOVE_STATUS_SUPER_EFFECTIVE | MOVE_STATUS_NOT_VERY_EFFECTIVE | MOVE_STATUS_ABILITY_TYPE_WEAKNESS)
