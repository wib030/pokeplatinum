...
#define MOVE_STATUS_DID_NOT_HIT_1   (MOVE_STATUS_MISSED | MOVE_STATUS_INEFFECTIVE | MOVE_STATUS_FAILED | MOVE_STATUS_LEVITATED \
                                    ...
                                    | MOVE_STATUS_TYPE_IMMUNE_HEAL_ABILITY)

#define MOVE_STATUS_DID_NOT_HIT_2   (MOVE_STATUS_TYPE_IMMUNE_RAISE_STAT_ABILITY | MOVE_STATUS_TYPE_IMMUNE_TYPE_BOOST_ABILITY | MOVE_STATUS_POWDER_IMMUNITY)
