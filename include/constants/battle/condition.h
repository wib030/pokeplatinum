...
#define MON_CONDITION_INCAPACITATED     (MON_CONDITION_SLEEP | MON_CONDITION_FREEZE)
#define MON_CONDITION_ANY_NOT_PARA      (MON_CONDITION_SLEEP | MON_CONDITION_POISON | MON_CONDITION_BURN | MON_CONDITION_FREEZE | MON_CONDITION_TOXIC)

#define MON_CONDITION_NOT_SLEEP         ~MON_CONDITION_SLEEP
#define MON_CONDITION_CAN_SYNCHRONIZE   (MON_CONDITION_POISON | MON_CONDITION_BURN | MON_CONDITION_PARALYSIS | MON_CONDITION_SLEEP | MON_CONDITION_FREEZE)
#define MON_CONDITION_FACADE_BOOST      (MON_CONDITION_TOXIC | MON_CONDITION_POISON | MON_CONDITION_BURN | MON_CONDITION_PARALYSIS | MON_CONDITION_SLEEP)
...
#define VOLATILE_CONDITION_INFLICTABLE  (VOLATILE_CONDITION_CONFUSION | VOLATILE_CONDITION_ATTRACT | VOLATILE_CONDITION_BIND | VOLATILE_CONDITION_MEAN_LOOK \
                                        | VOLATILE_CONDITION_FORESIGHT | VOLATILE_CONDITION_NIGHTMARE | VOLATILE_CONDITION_CURSE | VOLATILE_CONDITION_TORMENT)

#define VOLATILE_CONDITION_INFLICTABLE_NEGATIVE (VOLATILE_CONDITION_CONFUSION | VOLATILE_CONDITION_ATTRACT | VOLATILE_CONDITION_BIND | VOLATILE_CONDITION_MEAN_LOOK \
                                                | VOLATILE_CONDITION_NIGHTMARE | VOLATILE_CONDITION_CURSE | VOLATILE_CONDITION_TORMENT)
...
#define VOLATILE_CONDITION_BATON_PASSED (VOLATILE_CONDITION_FOCUS_ENERGY \
										...
										| VOLATILE_CONDITION_CHIP \
                                        | VOLATILE_CONDITION_SUBSTITUTE)
#define VOLATILE_CONDITION_TRAPPED      (VOLATILE_CONDITION_BIND \
                                        | VOLATILE_CONDITION_MEAN_LOOK)

#define VOLATILE_CONDITION_WONDER_GUARD (VOLATILE_CONDITION_CONFUSION | VOLATILE_CONDITION_CHIP | VOLATILE_CONDITION_BIND | VOLATILE_CONDITION_TRANSFORM \
                                        | VOLATILE_CONDITION_DESTINY_BOND | VOLATILE_CONDITION_NIGHTMARE | VOLATILE_CONDITION_CURSE | VOLATILE_CONDITION_FORESIGHT)
...
#define SIDE_CONDITION_DEEP_SNOW        (1 << 15)
...
#define SIDE_CONDITION_HAZARDS_ANY  (SIDE_CONDITION_SPIKES | SIDE_CONDITION_STEALTH_ROCK | SIDE_CONDITION_TOXIC_SPIKES | SIDE_CONDITION_STICKY_WEB)
#define SIDE_CONDITION_HAZARDS_DAMAGING  (SIDE_CONDITION_SPIKES | SIDE_CONDITION_STEALTH_ROCK | SIDE_CONDITION_TOXIC_SPIKES)
#define SIDE_CONDITION_DEFOGGABLE   (SIDE_CONDITION_HAZARDS_ANY | SIDE_CONDITION_REFLECT | SIDE_CONDITION_LIGHT_SCREEN | SIDE_CONDITION_SAFEGUARD \
                                    | SIDE_CONDITION_MIST)
#define SIDE_CONDITION_ENEMY_DEFOG  (SIDE_CONDITION_REFLECT | SIDE_CONDITION_LIGHT_SCREEN | SIDE_CONDITION_SAFEGUARD | SIDE_CONDITION_MIST)

#define FIELD_CONDITION_NONE            0
...
#define FIELD_CONDITION_SOLAR_DOWN  (FIELD_CONDITION_RAINING \
                                    ...
                                    | FIELD_CONDITION_HAILING \
                                    | FIELD_CONDITION_DEEP_FOG)
#define FIELD_CONDITION_CASTFORM    (FIELD_CONDITION_RAINING | FIELD_CONDITION_SUNNY | FIELD_CONDITION_HAILING | FIELD_CONDITION_SANDSTORM)
