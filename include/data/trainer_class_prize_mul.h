...
static u8 sTrainerClassPrizeMul[] = {
    ...
    [TRAINER_CLASS_SCIENTIST]               = 16,
    [TRAINER_CLASS_SWIMMER_MALE]            = 4,
    [TRAINER_CLASS_SWIMMER_FEMALE]          = 5,
    ...
    [TRAINER_CLASS_CHAMPION_CYNTHIA]        = 60,
    ...
    [TRAINER_CLASS_TRAINER_CHERYL]          = 20,
    [TRAINER_CLASS_TRAINER_RILEY]           = 15,
    [TRAINER_CLASS_TRAINER_MARLEY]          = 35,
    [TRAINER_CLASS_TRAINER_BUCK]            = 40,
    [TRAINER_CLASS_TRAINER_MIRA]            = 35,
    [TRAINER_CLASS_DP_PLAYER_MALE]          = 25,
    [TRAINER_CLASS_DP_PLAYER_FEMALE]        = 25,
    [TRAINER_CLASS_TOWER_TYCOON]            = 0,
    [TRAINER_CLASS_MAID]                    = 2,
