...
/**
 * @brief Get the Fling type for a battler's held item.
 *
...
/**
* @brief Determine whether the battler is a physical attacker or not.
*
* @param battleSys
* @param battleCtx
* @param battler    The currently-in battler slot number.
...
/**
* @brief Determines whether partymon ability deters contact moves.
*
* @param battleSys
* @param battleCtx
...
*/
 ...
 /**
* @brief Determines whether a battlemon ability deters contact moves.
*
* @param battleSys
* @param battleCtx
* @param defender   The battler ID of the defending mon
