...
_009:
	...
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_RAIN_DISH, _010
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_ICE_BODY, _010
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_PHOTOSYNTHESIS, _010
	CheckItemHoldEffect CHECK_HAVE, BTLSCR_MSG_TEMP, HOLD_EFFECT_NO_WEATHER_CHIP_POWDER, _090
    CompareVarToValue OPCODE_FLAG_SET, BTLVAR_FIELD_CONDITIONS, FIELD_CONDITION_SUNNY, _045
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_SAND_FORCE, _021
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_SAND_STREAM, _021
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_SLUSH_RUSH, _025
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_SNOW_WARNING, _025
	CheckAbility CHECK_HAVE, BTLSCR_MSG_TEMP, ABILITY_DRY_SKIN, _015
    // {1} is buffeted by the {0}!
    PrintMessage pl_msg_00000368_00285, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062
	
_010:
	CompareMonDataToValue OPCODE_NEQ, BTLSCR_ATTACKER, BATTLEMON_HEAL_INVERSION_TURNS, 0, _011
	// {1} is buffeted by the {0}!
    PrintMessage pl_msg_00000368_00285, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062
...
_015:
	CompareVarToValue OPCODE_FLAG_SET, BTLVAR_FIELD_CONDITIONS, FIELD_CONDITION_RAINING, _045
	// {1} is buffeted by the {0}!
    PrintMessage pl_msg_00000368_00285, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062
	
_021:
	CompareVarToValue OPCODE_FLAG_SET, BTLVAR_FIELD_CONDITIONS, FIELD_CONDITION_SANDSTORM, _090
	// {1} is buffeted by the {0}!
    PrintMessage pl_msg_00000368_00285, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062
	
_025:
	CompareVarToValue OPCODE_FLAG_SET, BTLVAR_FIELD_CONDITIONS, FIELD_CONDITION_HAILING, _090
	// {1} is buffeted by the {0}!
    PrintMessage pl_msg_00000368_00285, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062
