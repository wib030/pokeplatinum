...
_149:
    CompareVarToValue OPCODE_FLAG_NOT, BTLVAR_SIDE_CONDITIONS_DEFENDER, SIDE_CONDITION_STEALTH_ROCK, _159
...
_159:
    CompareVarToValue OPCODE_FLAG_NOT, BTLVAR_SIDE_CONDITIONS_DEFENDER, SIDE_CONDITION_STICKY_WEB, _114
    UpdateVar OPCODE_FLAG_OFF, BTLVAR_SIDE_CONDITIONS_DEFENDER, SIDE_CONDITION_STICKY_WEB
    UpdateVar OPCODE_SET, BTLVAR_MSG_MOVE_TEMP, MOVE_MUD_SPORT
    Call BATTLE_SUBSCRIPT_DEFOG_MESSAGE

_114:
    CheckSideCondition BTLSCR_ATTACKER, CHECK_SIDE_COND_VAL_ZERO, SIDE_COND_SPIKES_LAYERS, _134
    CheckSideCondition BTLSCR_ATTACKER, CHECK_SIDE_COND_CLEAR, SIDE_COND_SPIKES_LAYERS, _134
    UpdateVar OPCODE_FLAG_OFF, BTLVAR_SIDE_CONDITIONS_ATTACKER, SIDE_CONDITION_SPIKES
    UpdateVar OPCODE_SET, BTLVAR_MSG_MOVE_TEMP, MOVE_SPIKES
    Call BATTLE_SUBSCRIPT_DEFOG_MESSAGE

_134:
    CheckSideCondition BTLSCR_ATTACKER, CHECK_SIDE_COND_VAL_ZERO, SIDE_COND_TOXIC_SPIKES_LAYERS, _150
    CheckSideCondition BTLSCR_ATTACKER, CHECK_SIDE_COND_CLEAR, SIDE_COND_TOXIC_SPIKES_LAYERS, _150
    UpdateVar OPCODE_SET, BTLVAR_MSG_MOVE_TEMP, MOVE_TOXIC_SPIKES
    Call BATTLE_SUBSCRIPT_DEFOG_MESSAGE

_150:
    CompareVarToValue OPCODE_FLAG_NOT, BTLVAR_SIDE_CONDITIONS_ATTACKER, SIDE_CONDITION_STEALTH_ROCK, _155
    UpdateVar OPCODE_FLAG_OFF, BTLVAR_SIDE_CONDITIONS_ATTACKER, SIDE_CONDITION_STEALTH_ROCK
    UpdateVar OPCODE_SET, BTLVAR_MSG_MOVE_TEMP, MOVE_STEALTH_ROCK
    Call BATTLE_SUBSCRIPT_DEFOG_MESSAGE
	
_155:
    CompareVarToValue OPCODE_FLAG_NOT, BTLVAR_SIDE_CONDITIONS_ATTACKER, SIDE_CONDITION_STICKY_WEB, _165
