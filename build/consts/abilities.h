...
#ifndef __C___USERS__LBEAR___DOCUMENTS_____RO_MS_______DECOMPILATION__POKEPLATINUM__BUILD__CONSTS__ABILITIES_H
#define __C___USERS__LBEAR___DOCUMENTS_____RO_MS_______DECOMPILATION__POKEPLATINUM__BUILD__CONSTS__ABILITIES_H
...
enum Ability {
    ...
    ABILITY_SHAKEDOWN = 143,
    ABILITY_FLARE_BOOST = 144,
    ABILITY_CHLOROPLAST = 145,
    ABILITY_RANDOM_SELECT = 146,
    ABILITY_COTTON_DOWN = 147,
    ABILITY_PHOTOSYNTHESIS = 148,
    ABILITY_SHARPNESS = 149,
    ABILITY_STRANGLE_WEED = 150,
    ABILITY_PEST = 151,
    ABILITY_GENETIC_FREAK = 152,
    ABILITY_UNOWN_ENERGY = 153,
    ABILITY_ROCK_SOLID = 154,
};
